...
if (mysqli_num_rows($get_item_res) < 1) {
   ...
   //make nav directory and display item info
...
END_OF_TEXT;
   ...
   //pull and display color options from the database
   ...
   //pull and display size options from the database
   ...
   //closing tag for HTML display block
   $display_block .= "</div>";
